...
#define BLYNK_TEMPLATE_ID "TMPLUKrbiUuk"
...
char auth[] = "7qoaKBnQqxi7slWcKYTTz64Zbx0EObJN";

// Your WiFi credentials.
// Set password to "" for open networks.
const char* ssid = "4th FLOOR EMBEDDED DEPT";   // your network SSID (name) 
const char* password = "Ymts@Takeoff"; 
//char ssid[] = "4th FLOOR EMBEDDED DEPT";
//char pass[] = "Ymts@Takeoff";

WiFiClient  client;
int x;
unsigned long myChannelNumber = x;
const char * myWriteAPIKey = "0NI90RNPBLFWB5LF";
...
#define ECHO             18 //D16  pin connected with DHT
#define TRIG            34 //D34  pin connected with LDR
#define IR 13  //D13
#define GAS 12 //D12
...
#define VPIN_ALL_ON    V3 
#define VPIN_ALL_OFF    V4
#define VPIN_IR    V5 
#define VPIN_GAS    V6
#define VPIN_DISTANCE    V7 
...
void readSensor(){
  ...
  durations=pulseIn(ECHO,HIGH);
  distance=(durations*0.034)/2;
  ...
  if ((millis() - lastTime) > timerDelay) {
    ...
    ThingSpeak.setField(1, ir_val);
    //ThingSpeak.setField(1, temperatureF);
    ThingSpeak.setField(2, gas_val);
...
void sendSensor()
{
  ...
  Blynk.virtualWrite(VPIN_IR, ir_val);
  Blynk.virtualWrite(VPIN_GAS, gas_val);
   if((ir_val==0)||(gas_val==0)){
    Blynk.email("jijumolbabu75@gmail.com", "ESP8266 Alert", "EMERGENCY!");
    Blynk.notify("ESP8266 Alert - EMERGENCY!");
  }
